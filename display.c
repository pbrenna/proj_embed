...
#include "util.h"
__code unsigned char init_d[] = {0x38,0x39,0x14,0x74,0x54,0x6f,0x0f,0x01};
unsigned char gotoaddr_command[] = {0x80, 0};
__code unsigned char clear_command[] = {0x80,0x01};
...
char _display_string[] = "@TEMP=      ";
void display_write_data(){
	num2string(therm_old, 1, _display_string+6);
