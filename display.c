...
void display_write_data_1(){
	memcpy(_display_string_1, sizeof(_display_string_1), _display_string);
...
void display_write_data_2(){
	memcpy(_display_string_2, sizeof(_display_string_2), _display_string);
	num2string(average[1], 1, _display_string+3);
	num2string(average[2], 1, _display_string+9);
